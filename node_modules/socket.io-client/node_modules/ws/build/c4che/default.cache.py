...
CPPPATH_NODE = '/afs/acm.uiuc.edu/user/marsan1/.nvm/v0.4.12/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g', '-O3']
...
LIBDIR = '/afs/acm.uiuc.edu/user/marsan1/.node_libraries'
LIBPATH_NODE = '/afs/acm.uiuc.edu/user/marsan1/.nvm/v0.4.12/lib'
LIBPATH_ST = '-L%s'
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/afs/acm.uiuc.edu/user/marsan1/.node_libraries'
PREFIX = '/usr/local'
PREFIX_NODE = '/afs/acm.uiuc.edu/user/marsan1/.nvm/v0.4.12'
